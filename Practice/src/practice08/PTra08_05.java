...
public class PTra08_05 {
	public static void main(String[] args) {
		...
		if(choice == 1) {
		 double shikaku = quadrangle(width,height);
		 System.out.println(shikaku);

		}else if(choice == 2){
		double sankaku = triangle(width,height);
